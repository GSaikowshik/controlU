        ...
        <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 shadow-2xl glow-card">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className="w-full bg-[#0b0f19] hover:bg-[#111726] border border-slate-800 hover:border-slate-700 text-white font-medium rounded-2xl py-3.5 text-sm flex items-center justify-center gap-3 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
            >
            ...
            {/* Neon/Dark Accent Divider */}
            <div className="relative flex items-center justify-center my-6">
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t border-slate-800" />
              </div>
              <span className="relative px-4 bg-[#0a0e17] text-slate-500 text-xs font-mono tracking-widest uppercase">
                OR
              </span>
            </div>
